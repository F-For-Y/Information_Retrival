...
class TestRankingMetrics(unittest.TestCase):
    ...
    def test_bm25_single_word_query(self):
        ...
        index = Indexer.create_index(IndexType.BasicInvertedIndex, 'dataset_1.jsonl', RegexTokenizer('\\w+'), set(), 0)
...
#            print(score)
            self.assertAlmostEqual(score, expected_score,
                                   msg='Wrong score for docid %d, expected %f' % (docid, expected_score),
                                   places=3)
    ...
    def test_bm25_multi_word_query(self):
        ...
        for docid, expected_score in docid_to_score.items():
            score = bm25.score(docid, docid_to_word_counts[docid], Counter(['ai', 'chatbots', 'vehicles']))
#            print(docid)
#            print(score)
            self.assertAlmostEqual(score, expected_score, 
                                   msg='Wrong score for docid %d, expected %f' % (docid, expected_score),
...
#                print(score)
    ...
    def test_tf_idf_multi_word_query(self):
        ...
        for docid, expected_score in docid_to_score.items():
            score = tfidf.score(docid, docid_to_word_counts[docid], Counter(['ai', 'chatbots',  'vehicles']))
#            print(docid)
#            print(score)
            self.assertAlmostEqual(score, expected_score, 
                                    msg='Wrong score for docid %d, expected %f' % (docid, expected_score),
...
#                print(score)
    ...
    def test_pivoted_normalization_multi_word_query(self):
        ...
        for docid, expected_score in docid_to_score.items():
            score = pn.score(docid, docid_to_word_counts[docid], Counter(['ai', 'chatbots', 'vehicles']))
#            print(docid)
#            print(score)
            self.assertAlmostEqual(score, expected_score, 
                                    msg='Wrong score for docid %d, expected %f' % (docid, expected_score),
