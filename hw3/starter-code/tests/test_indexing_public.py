...
class TestIndexer_BasicInvertedIndex(unittest.TestCase):
    ...
    def test_create_index_with_stopwords_with_mwf(self):
        ...
        index = Indexer.create_index(self.index_type, 'dataset_2.jsonl', self.tokenizer, stopwords, 2)
    ...
    def test_create_index_with_document_augmentation(self):
        ...
        index = Indexer.create_index(self.index_type, 'dataset_2.jsonl', self.tokenizer, stopwords, 2, doc_augment_dict=doc_augmentation_dict)
